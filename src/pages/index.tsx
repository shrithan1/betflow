...
const teamLogos: Record<string, string> = {
  "Patriots": "/public/patriots-logo.png", // Replace with actual logo URL
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              {game.teams.map((team, teamIndex) => (
                <button
                  ...
                  style={{
                    backgroundColor: selectedGame?.game === game.time && selectedGame?.team === team.name ? '#007aff' : '#1e293b',
                    color: 'white',
                    padding: '10px',
                    borderRadius: '5px',
                    border: 'none',
                  ...
                  />
                  <span>{team.name} ({team.record})</span>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
          <button
            ...
            style={{
              backgroundColor: selectedGame?.team === 'Patriots' ? '#007aff' : '#1e293b',
              color: 'white',
              padding: '10px',
              borderRadius: '5px',
              border: 'none',
          ...
          <button
            ...
            style={{
              backgroundColor: selectedGame?.team === 'Jaguars' ? '#007aff' : '#1e293b',
              color: 'white',
              padding: '10px',
              borderRadius: '5px',
              border: 'none',
        ...
        <div style={{ marginBottom: '20px' }}>
          <p>Avg Price: {selectedGame?.team === 'Patriots' ? '0¢' : selectedGame?.team === 'Jaguars' ? '0¢' : '0¢'}</p>
          <p>Shares: 0.00</p>
